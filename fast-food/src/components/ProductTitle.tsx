...
export default function ProductTitle({ info }: { info: Product }) {
    ...
    return (
        <div className="relative">
            ...
            <svg
                className={info.isLiked ? "right-4 bottom-[9px] absolute bg-[url('/red.svg')] bg-no-repeat bg-contain bg-center w-4 h-4 cursor-pointer" : "right-4 bottom-[9px] absolute bg-[url('/heart.svg')] bg-no-repeat bg-contain bg-center w-4 h-4 cursor-pointer"}
